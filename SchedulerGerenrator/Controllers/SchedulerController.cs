...
namespace SchedulerGerenrator.Controllers
{
    ...
    public class SchedulerController : ControllerBase
    {
        ...
        public IEnumerable<TrayResponse> Get([Required, NotNull] List<TrayRequest> trays)
        {
            //get recipes
            List<Recipe> recipes = GetRecipes();

            var scheduler = TransformToScheduler(recipes, trays);
        ...
        /// <summary>
        /// Request list of know recipes  from external api or cache
        /// </summary>
